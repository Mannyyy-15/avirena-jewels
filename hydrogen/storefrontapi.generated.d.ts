...
export type StorefrontProductsQueryVariables = StorefrontAPI.Exact<{
...
export type StorefrontProductByHandleQueryVariables = StorefrontAPI.Exact<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query StorefrontProducts($first: Int = 50) {\n    products(first: $first) {\n      edges {\n        node {\n          id\n          title\n          handle\n          description\n          productType\n          tags\n          availableForSale\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          compareAtPriceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          images(first: 10) {\n            edges {\n              node {\n                url\n                altText\n              }\n            }\n          }\n          media(first: 20) {\n            edges {\n              node {\n                mediaContentType\n                alt\n                ... on Video {\n                  sources { url mimeType }\n                  previewImage { url }\n                }\n                ... on MediaImage {\n                  image { url }\n                }\n              }\n            }\n          }\n          variants(first: 20) {\n            edges {\n              node {\n                id\n                title\n                availableForSale\n                quantityAvailable\n                price {\n                  amount\n                  currencyCode\n                }\n                selectedOptions {\n                  name\n                  value\n                }\n                sku\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: StorefrontProductsQueryVariables;
  };
  '#graphql\n  query StorefrontProductByHandle($handle: String!) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      description\n      productType\n      tags\n      availableForSale\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      compareAtPriceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      images(first: 10) {\n        edges {\n          node {\n            url\n            altText\n          }\n        }\n      }\n      media(first: 20) {\n        edges {\n          node {\n            mediaContentType\n            alt\n            ... on Video {\n              sources { url mimeType }\n              previewImage { url }\n            }\n            ... on MediaImage {\n              image { url }\n            }\n          }\n        }\n      }\n      variants(first: 20) {\n        edges {\n          node {\n            id\n            title\n            availableForSale\n            quantityAvailable\n            price {\n              amount\n              currencyCode\n            }\n            selectedOptions {\n              name\n              value\n            }\n            sku\n          }\n        }\n      }\n    }\n  }\n': {
    return: StorefrontProductByHandleQuery;
    variables: StorefrontProductByHandleQueryVariables;
  };
