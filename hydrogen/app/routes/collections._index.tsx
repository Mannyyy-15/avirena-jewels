...
export const meta: Route.MetaFunction = () => {
  return [
    { title: 'Curated Jewellery Collections & Suites | AVIRENA' },
    {
      name: 'description',
      content:
        'Explore our architectural collections and signature duo suites in anti-tarnish brass. Discover molten ear artifacts, baroque pearl drops, and sculptural bands.',
    },
    {
      tagName: 'link',
      rel: 'canonical',
      href: 'https://avirenajewels.com/collections',
    },
  ];
};
...
export default function CollectionsHubPage() {
  ...
  return (
    <div ref={containerRef} className="pb-24 font-sans-body w-full text-[#413C23] bg-[#E7E4D5] select-none">
      ...
      <section className="sticky top-16 sm:top-20 z-30 w-full px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 py-3.5 bg-[#E7E4D5]/95 backdrop-blur-md border-b border-[#D8D2C2]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {SUITES.map((suite, idx) => {
              ...
              return (
                <div
                  key={suite.id}
                  onClick={() => navigate(`/shop/${suite.category}`)}
