...
export const meta: MetaFunction = () => {
  return [
    { title: 'FAQs, Sizing Guide & Jewelry Care | AVIRENA' },
    {
      name: 'description',
      content:
        'Explore Avirena Jewels FAQs: ring sizing charts, brass jewelry anti-tarnish care instructions, 6-month anti-tarnish guarantee, and express delivery details.',
    },
    { property: 'og:title', content: 'FAQs, Sizing Guide & Jewelry Care | AVIRENA' },
    {
      property: 'og:description',
      content:
        'Detailed answers on brass alloy materials, protective anti-tarnish coatings, ring sizing, and 6-month guarantee.',
    },
