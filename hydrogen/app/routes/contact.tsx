...
export const meta: MetaFunction = () => {
  return [
    { title: 'Contact Concierge & Support | AVIRENA' },
    {
      name: 'description',
      content:
        'Connect with Avirena Jewels customer concierge. Inquire about sizing, custom styling, anti-tarnish jewelry care, or express order updates.',
    },
    { property: 'og:title', content: 'Contact Concierge & Support | AVIRENA' },
    {
      property: 'og:description',
      content:
        'We are here to assist with sizing, orders, and anti-tarnish jewelry care. Reach our atelier via WhatsApp or email.',
    },
...
export default function ContactPage() {
  ...
  return (
    <div className="font-sans-body text-[#413C23] bg-[#E7E4D5] pb-24 overflow-hidden w-full select-none">
      {/* 1. TOP HEADER BANNER */}
      ...
      <section className="w-full px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto text-left">
          ...
          <div className="bg-[#F2EFDB] p-6 sm:p-8 rounded-xs border border-[#D8D2C2] space-y-3.5 hover:border-[#8F896D] transition-all hover:shadow-sm flex flex-col justify-between">
          ...
          <div className="bg-[#F2EFDB] p-6 sm:p-8 rounded-xs border border-[#D8D2C2] space-y-3.5 hover:border-[#8F896D] transition-all hover:shadow-sm flex flex-col justify-between">
            ...
            <a
              href="mailto:avirenajewels@gmail.com"
              className="inline-flex items-center gap-1.5 text-xs text-[#413C23] hover:text-[#8F896D] font-medium uppercase tracking-wider pt-2 transition-colors"
            >
              <span>avirenajewels@gmail.com</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </a>
          </div>
