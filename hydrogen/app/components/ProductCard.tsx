...
import type { Product, Currency, Metal } from '~/types/storefront';
import { formatPrice, getCompareAtPrice, getDiscountPercentage } from '~/lib/currency';
...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const [selectedMetal] = useState<Metal>(product.metal);
  ...
  const href = to || `/product/${product.handle || product.id}`;
